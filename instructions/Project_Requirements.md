# CS 1440 Project 3: Big Data Processing - Project Requirements
...
*   Method
    *   `add_record(self, record, areas)`
        ...
        *   It could happen that two or more FIPS areas tie for maximum wages, number of establishments or employment level.
